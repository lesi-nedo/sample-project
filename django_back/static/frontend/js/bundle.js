var app = (function () {
	...
	var on_click_1 = (__1, count) => set(count, get(count) - 1);
	var on_click_2 = (__2, count) => set(count, 0);

	var root = add_locations(template(`<div class="p-6 bg-white rounded-lg shadow-md max-w-md mx-auto mt-10 space-y-4"><h1 class="text-3xl font-bold underline">Hello world!</h1> <p class="text-lg">This is a Svelte app with Tailwind CSS.</p> <p class="text-lg"> </p> <div class="flex space-x-2"><button class="flex-1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Increment</button> <button class="flex-1 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Decrement</button> <button class="flex-1 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Reset</button></div></div>`), App[FILENAME], [
		[
			7,
			0,
			[
	...
	function App($$anchor, $$props) {
		...
		button_2.__click = [on_click_2, count];
